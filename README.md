...
🤖 Machine Learning & Deep Learning (TensorFlow, scikit-learn, CV, NLP)

📊 Data Analysis & Data Engineering (Pandas, Numpy, Matplotlib, Seaborn)

🖥️ Fullstack Development (Flutter, JS, HTML/CSS, Streamlit dashboards)
